...
FROM FISCALIZACAO_ETL_RW.STG_TBOCORRENCIA s
JOIN FISCALIZACAO_ETL_RW.STG_VW_BDBARRAGEM b ON s.IDBARRAGEM = b.IDBARRAGEM
JOIN FISCALIZACAO_ETL_RW.TEMP_CAMPANHA_MAP m ON s.IDBARRAGEM = m.IDBARRAGEM
...
DECLARE
  ...
  END;
BEGIN
  sync_sequence('FISCALIZACAO.FISSQ_CAMPANHA', 'FISCALIZACAO.FISTB_CAMPANHA', 'CAM_CD');
  sync_sequence('FISCALIZACAO.FISSQ_VISTORIABARRAGEM', 'FISCALIZACAO.FISTB_VISTORIA_BARRAGEM', 'VIB_CD');
  sync_sequence('FISCALIZACAO.FISSQ_OCORRENCIA', 'FISCALIZACAO.FISTB_OCORRENCIA', 'OCO_CD');
  sync_sequence('FISCALIZACAO.FISSQ_INSTFISCALIZACAO', 'FISCALIZACAO.FISTB_INSTRUMENTOFISCALIZACAO', 'AUI_CD');
