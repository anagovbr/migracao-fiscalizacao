...
SELECT
  ...
  NULL  -- AUI_IC_TEXTDEZ
FROM STG_TBOCORRENCIA s
JOIN STG_TBVISTORIA v2 ON s.IDVISTORIA = v2.IDVISTORIA
JOIN TEMP_CAMPANHA_MAP m ON v2.IDVISTORIA = m.IDVISTORIA
JOIN FISCALIZACAO_MIGRACAO.FISTB_OCORRENCIA o ON o.OCO_NU_PROTOCOLO = s.OCORRENCIANUMERODOC
LEFT JOIN STG_TBTECNICO t ON s.IDTECNICO = t.IDTECNICO
