DROP TABLE TEMP_CAMPANHA_MAP;
DROP TABLE FISTB_CAMPANHA_TEMP;
DROP TABLE FISTB_VISTORIA_BARRAGEM_TEMP;
DROP TABLE FISTB_OCORRENCIA_TEMP;
DROP TABLE FISTB_INSTRUMENTOFISCALIZACAO_TEMP;
