...
SELECT
  ...
  t.TECNICONOME, -- AUI_DS_NOTIFICADOA
  s.OCORRENCIAPRAZO, -- AUI_VL_PRAZOPROVIDENCIA
  0, -- AUI_IC_PRAZOIMEDIATO
  t.TECNICONOME, -- AUI_NU_LOCAL_IBGEMUNICIPIO
  t.TECNICOMATRICULA, -- AUI_NM_SERVIDOR
  s.OCORRENCIANUMEROAR, -- AUI_NU_SIAPE
  1, -- AUI_NU_AUTOINFRACAO
  s.DTDOCUMENTO, -- AUI_IC_LAVRADOEMCAMPO
  s.OCORRENCIANUMERODOCREF, -- AUI_NU_RASTREAMENTOAR
  0, -- AUI_IC_ASSOCIADOCAMPANHA
  s.OCORRENCIANUMERODOC, -- AUI_DT_RECEBIMENTOAR
  s.DTDOCUMENTO, -- AUI_NU_DOCUMENTOREFERENCIA
